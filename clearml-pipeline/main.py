...
if __name__ == '__main__':
    ...
    models = []
    model_paths = [os.path.join("../models", "final_111_DeepFakeClassifier_tf_efficientnet_b7_ns_0_36")]
    ...
    test_videos = sorted([x for x in os.listdir("E:/deepfake-detection-dataset/test-deepfake-detection-0.1") if x[-4:] == ".mp4"])
    ...
    predictions = predict_on_video_set(face_extractor=face_extractor, input_size=input_size, models=models,
                                       ...
                                       num_workers=6, test_dir="E:/deepfake-detection-dataset/test-deepfake-detection-0.1")
